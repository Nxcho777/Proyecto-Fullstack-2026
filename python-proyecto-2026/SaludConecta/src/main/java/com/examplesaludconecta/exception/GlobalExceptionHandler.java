...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> manejarMicroservicioNoDisponible(
            MicroservicioNoDisponibleException ex
    ) {
        log.error("Fallo en comunicación remota: {}", ex.getMessage());
        return crearRespuesta(HttpStatus.SERVICE_UNAVAILABLE, "Microservicio no disponible", ex.getMessage());
    }
    ...
    public ResponseEntity<Map<String, Object>> manejarValidacionesDeServicio(ConstraintViolationException ex) {
        Map<String, Object> respuesta = respuestaBase(
                HttpStatus.BAD_REQUEST,
                "La validación de la regla solicitada ha resultado fallida"
        );
    ...
    public ResponseEntity<Map<String, Object>> manejarErrorGeneral(Exception ex) {
        log.error("Error no controlado en SaludConecta", ex);
        return crearRespuesta(
